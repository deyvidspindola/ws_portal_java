<jsp:directive.include file="/WEB-INF/views/includes.jsp"/>
	...
	<script type="text/javascript">
		...
		function submeteFormInstrucaoTesteOdometroCAN(form){
			...
			//configuracoes para tirar os caches - IE
				...
				$.ajax({
					...
					success: function(json){
						...
						if (json.success) {
							$(form).attr("action", "${pageContext.request.contextPath}/Satellite?pagename=SascarPortal_Corporativo/RepresentanteTecnico&page=Corporativo/UC13/dv15");
							$(form).unbind('submit').submit();
				...
				submitHandler : function(form) {
					...
					<c:if test="${not empty teste.tipoTeste}">
						...
						if(numeroWS == 163){
							...
							if(tipoTeste == 'OCAN') {
								// Odometro CAN
								submeteFormInstrucaoTesteOdometroCAN(form);

							} else if(exibeConfirmacao == true){
								//Odometro Inicial
	...
	<form id="formInstrucaoTeste" action="" method="post">
		...
		<div class="principal">
			...
			<div class="bloco">
				...
				<c:if test="${teste.tipoTeste eq 'OF' or teste.tipoTeste eq 'OCAN'}" >
					<div class="celula positionCelulaInstrucaoTeste">
						<div class="colunaLabelInstrucaoTeste">
							<label><fmt:message key="label.kilometragem" /></label>
						</div>

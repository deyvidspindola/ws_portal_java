...
<form id="formPesquisa" action="${pageContext.request.contextPath}/Satellite?pagename=SascarPortal_Corporativo/RepresentanteTecnico&page=Corporativo/UC10/dv06" method="post" class="filtro">
	...
	<div class="pgstabela" align="center">
		<p>	
			<c:if test="${not empty isPossuiRedeAcessorio and isPossuiRedeAcessorio == true}">
				<input class="button4" type="button" onclick="window.location.href ='${pageContext.request.contextPath}/Satellite?pagename=SascarPortal_Corporativo/RepresentanteTecnico&page=Corporativo/UC10/dv05_rede&numeroOS=${param.numeroOS}&numeroContrato=${param.numeroContrato}&isPossuiRedeAcessorio=${isPossuiRedeAcessorio}'" value="<fmt:message key="label.voltar" />">
			</c:if>
			<c:if test="${empty isPossuiRedeAcessorio or  isPossuiRedeAcessorio == false}">
				<input class="button4" type="button" onclick="window.location.href ='${pageContext.request.contextPath}/Satellite?pagename=SascarPortal_Corporativo/RepresentanteTecnico&page=Corporativo/UC10/dv04&numeroOS=${param.numeroOS}&numeroContrato=${param.numeroContrato}&isPossuiRedeAcessorio=${isPossuiRedeAcessorio}'" value="<fmt:message key="label.voltar" />">
			</c:if>

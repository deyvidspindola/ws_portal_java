...
(function($) {
	...
	$.anythingSlider = function(el, options) {
		...
		base.buildNextBackButtons = function() {
			...
			base.$forward = $('<a class="txtIndent bt_prox" href="#">' + base.options.forwardText + '</a>');
			base.$back = $('<a class="txtIndent bt_ant" href="#">' + base.options.backText + '</a>');
			...
			base.$wrapper.append(base.$forward).prepend(base.$back);

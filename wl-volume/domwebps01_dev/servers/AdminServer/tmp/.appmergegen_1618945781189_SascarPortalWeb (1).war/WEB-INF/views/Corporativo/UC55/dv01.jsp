<jsp:directive.include file="/WEB-INF/views/includes.jsp"/>
	...
	<!--  TELA REFERENTE AO POPUP ENTRAR OU FECHAR CHAT - REPRESENTANTE TECNICO -->
		...
		$(document).ready(function(){		
			...
			$('#js-entrar-chat').bind('click', function(){
				...
				if(os == "" && parametroCI == ""){
					...
					$.closeOverlay();
					document.location.href="/SascarPortalWeb/Satellite?pagename=SascarPortal_Corporativo/RepresentanteTecnico";
	...
	<input type="hidden" id="js-tipoUsuario" name="tipoUsuario" value="${SascarUser.perfil}"  />
		...
		<table style="margin-left: 55px; margin-top: -10px;">
			...
			<tr>
				<td><fmt:message key="label.oS" />:</td>
				<td><input type="text" id="js-os" name="os" /></td>
			</tr>
			<tr></tr>
			<tr>
				...
				<td style="
					...
					margin-top: -3px;
					color: #FF0000;">
					<span style="display: none;" class="" id="js-valida-nome"><fmt:message key="mensagem.informacao.campoNomePreenchido" /></span><br>
					<span style="display: none;" class="" id="js-valida-os"><fmt:message key="mensagem.informacao.osInformada" /></span>
				</td>				
			</tr>	
		</table>	
	</div>

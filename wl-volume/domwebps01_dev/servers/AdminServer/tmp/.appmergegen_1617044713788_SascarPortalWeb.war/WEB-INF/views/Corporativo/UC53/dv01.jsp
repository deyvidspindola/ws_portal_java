...
$(document).ready(function(){	
	...
	$("#formPesquisa").validate({
		...
		messages: {
		    ...
		    horarioContinuo: {				 
				required: '<fmt:message key="uc53.texto.005.selecioneIndisponibilizarOuContinuo" />'
		    },
		    horarioInicial: {				 
    ...
    function atualizarAgendaInstalador(){
       ...
       var acao = "1";
       var disponibilizaIndisponibiliza = "I";
       ...
       $('input:radio[name=horarioContinuo]').each(function() {
 	   ...
 	   $.ajax({
		    ...
		    data:    {"acao"                                : acao,
		        ...
		        if (json.success) {
			  		$("#dialog_mensagem_indisponibilizado").jOverlay();	
				} else {
    ...
    function confirm_indisponibilizar(){
     	...
     	$("#dialog_mensagem_confirm_indisponibilizar").jOverlay({'onSuccess' : function(){ 
    	 
     	}});
    }
	
	
	function redireciona_para_div2(){
		...
		window.location.href = '${pageContext.request.contextPath}/Satellite?pagename=SascarPortal_Corporativo/RepresentanteTecnico&page=Corporativo/UC53/dv02&dataInicial='+dataInicial+'&dataFinal='+dataFinal+'&codigoInstalador='+codigoInstalador+'&horarioInicial='+horarioInicial+'&horarioFinal='+horarioFinal+'&horarioContinuo='+horarioContinuo;
	}
...
<div class="busca_cinza">            
			<input   type="radio" name="disponibilizaIndisponibiliza" value="I" tabindex="1"  id="indisponibilizarAgenda" checked="checked" style="margin-right: 5px;" /><span class="text3"><fmt:message key="label.indisponibilizarAgenda" /></span>
     		<input  type="radio" name="disponibilizaIndisponibiliza" value="D"  tabindex="2"  onclick="redireciona_para_div2();" id="disponibilizarAgenda" style="margin-right: 5px;" /><span class="text3"><fmt:message key="label.disponibilizarAgenda" /></span>
	</div>
	...
	<div class="busca_cinza">
		...
		<label>
     			...
     			<input tabindex="4" type="text" maxlength="10" name="dataInicial" id="dataInicial" value="${param.dataInicial}" class="dateBR text data" readonly="readonly" />
     	</label>
     	<span class="text3">a</span>
     	<label>     				
			<input tabindex="5" type="text" maxlength="10" name="dataFinal" id="dataFinal" class="dateBR text data"  value="${param.dataFinal}" readonly="readonly" />
		</label>
	</div>
    ...
    <div class="busca_branca" style="width:820px;">            
			<input tabindex="8"  type="radio" name="horarioContinuo" value="N"  id="indisponibilizarHorario" style="margin-right: 5px;" /><span class="text3"><fmt:message key="label.indisponibilizarHorario" /></span><span class="texthelp2" style="*position:absolute;*margin-left:355px;*margin-top:0px;">
					<img src="${pageContext.request.contextPath}/sascar/images/corporativo_new/lightbulb32.png" alt="" width="16" height="16"  hspace="5" align="absmiddle"/><fmt:message key="uc53.texto.001.indisponibilizarHorario" /><br />
				</span><br><br><br>
     		<input tabindex="9" type="radio" name="horarioContinuo" value="C"  id="indisponibilizarHorario" style="margin-right: 5px;" /><span class="text3"><fmt:message key="label.indisponibilizarHorarioContinuo" /></span><span class="texthelp2" style="*position:absolute;*margin-left:310px;*margin-top:0px">
					<img src="${pageContext.request.contextPath}/sascar/images/corporativo_new/lightbulb32.png" alt="" width="16" height="16"  hspace="5" align="absmiddle"/><fmt:message key="uc53.texto.002.indisponibilizarHorarioContinuo" /><br />
				</span>
	</div>
	    ...
	    <div class="busca_cinza" align="center">
 	     <input type="submit" class="button" tabindex="10" value="<fmt:message key="btn.indisponibilizar" />" />	
   	    </div>
   	
  
</form>

    <div id="dialog_mensagem_confirm_indisponibilizar" class="popup_padrao" style="display: none;">        
			<div class="popup_padrao_pergunta"><fmt:message key="mensagem.confirmacao.indisponibilizacaoAgenda" /></div>
	 ...
	 <div id="dialog_mensagem_indisponibilizado" class="popup_padrao" style="display: none;">        
			<div class="popup_padrao_pergunta"><fmt:message key="mensagem.sucesso.indisponibilizacaoAgenda" /></div>
		    <div class="popup_padrao_resposta">
			<input name="" type="submit" class="button close" value="OK" onclick="window.location.href = '${pageContext.request.contextPath}/Satellite?pagename=SascarPortal_Corporativo/RepresentanteTecnico&page=Corporativo/UC53/dv01'"/>

...
if [ ! -f ${DOMAIN_HOME}/servers/${ADMIN_NAME}/logs/${ADMIN_NAME}.log ]; then
   ...
   echo "=========================="
   cp /u01/oracle/lib-ext/* ${DOMAIN_HOME}/lib

   echo "Copying Portal Serviço properties"
   echo "=========================="
   mkdir -p ${DOMAIN_HOME}/resources/portal_servicos
   cp /u01/oracle/portal_servicos/* ${DOMAIN_HOME}/resources/portal_servicos
